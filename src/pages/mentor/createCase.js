...
const NewCase = () => {
  ...
  const handleSubmit = () => {
    ...
    console.log('Case submitted:', { title, description, pathway, subCounty, active });
  };
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label>
          ...
          <select value={pathway} onChange={(e) => setPathway(e.target.value)}>
            ...
            <option value="hospitality tourism"> Hospitality ans Tourism</option>
            <option value="digital literacy">Digital Literacy</option>
            <option value="formal and informal">Looking for formal/informal employment</option>
          </select>
        </label>
        <br /> <br />
        <label>
          Sub County:
          <select type="text" value={subCounty} onChange={(e) => setSubCounty(e.target.value)}>
